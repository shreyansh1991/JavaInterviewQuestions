...
//String s=js.executeScript("return document.getElementById('js-flash-container').textContent").toString();
String s=js.executeScript("return arguments[0].textContent",driver.findElement(By.className("gb_P"))).toString();
